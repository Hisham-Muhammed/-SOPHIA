...
if (Config.WORKTYPE == 'private') {
    ...
    MyPnky.tosophia({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    MyPnky.tosophia({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
...
await message.sendMessage(r_text[i]);
    ...
    MyPnky.tosophia({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    MyPnky.tosophia({pattern: 'song', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
