...
if (Config.WORKTYPE == 'private') {
    Sophia.tosophia({ pattern: 'scan ?(.*)', fromMe: true, desc: Lang.SCAN}, (async (message, match) => { 
    ...
    Sophia.tosophia({ pattern: 'scan ?(.*)', fromMe: false, desc: Lang.SCAN}, (async (message, match) => { 
