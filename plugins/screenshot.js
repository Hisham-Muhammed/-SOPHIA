...
if (Config.WORKTYPE == 'private') {
    ...
    Sophia.tosophia({pattern: 'ss ?(.*)', fromMe: true, desc: Lang.SS_DESC}, (async (message, match) => {
    ...
    Sophia.tosophia({pattern: 'ss ?(.*)', fromMe: false, desc: Lang.SS_DESC}, (async (message, match) => {
