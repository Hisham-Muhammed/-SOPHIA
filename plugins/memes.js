...
if (Config.WORKTYPE == 'private') {
    ...
    Sophia.tosophia({pattern: 'meme ?(.*)', fromMe: true, desc: Lang.MEMES_DESC}, (async (message, match) => {   
    ...
    Sophia.tosophia({pattern: 'meme ?(.*)', fromMe: false, desc: Lang.MEMES_DESC}, (async (message, match) => {    
