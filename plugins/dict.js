...
Sophia.tosophia({pattern: 'lngcode', fromMe: false, dontAddCommandList: true}, (async (message, match) => {    
...
/*Sophia.tosophia({pattern: 'dict ?(.*)', fromMe: false,  dontAddCommandList: true }, async (message, match) => {
...
/*Sophia.tosophia({ pattern: 'dict ?(.*)', fromMe: false, desc: "Use it as a dictionary.\nEg: .dict en_US;lead\n For supporting languages send *.lngcode*" }, async (message, match) => {
