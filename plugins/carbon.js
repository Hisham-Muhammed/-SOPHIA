...
if (Config.WORKTYPE == 'private') {
    ...
    Sophia.tosophia({pattern: 'carbon$', fromMe: true, desc: Lang.CARBON_DESC}, (async (message, match) => {
    ...
    Sophia.tosophia({pattern: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC}, (async (message, match) => {
