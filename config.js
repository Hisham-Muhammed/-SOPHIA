...
module.exports = {
    ...
    BOT_PRESENCE: process.env.BOT_PRESENCE === undefined ? 'recording' : process.env.BOT_PRESENCE,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'SOPHIA BOT' : process.env.BOT_NAME,
